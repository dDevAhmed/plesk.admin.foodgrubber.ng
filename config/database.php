    ...
    */
    ...
    'connections' => [
        ...
        'foodgrubber_admin' => [
            ...
            'unix_socket' => env('DB_SOCKET_ADMIN', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
            ...
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('MYSQL_ATTR_SSL_CA_ADMIN'),
            ]) : [],
        ],
        ...
        'foodgrubber_foodpartners' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL_FOODPARTNERS'),
            'host' => env('DB_HOST_FOODPARTNERS', '127.0.0.1'),
            'port' => env('DB_PORT_FOODPARTNERS', '3306'),
            'database' => env('DB_DATABASE_FOODPARTNERS', 'forge'),
            'username' => env('DB_USERNAME_FOODPARTNERS', 'forge'),
            'password' => env('DB_PASSWORD_FOODPARTNERS', ''),
            'unix_socket' => env('DB_SOCKET_FOODPARTNERS', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
            ...
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('MYSQL_ATTR_SSL_CA_FOODPARTNERS'),
            ]) : [],
        ],
